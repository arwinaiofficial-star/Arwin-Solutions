...
function Tracker({
  ...
  const columns: { status: TrackedJob["status"]; label: string; color: string }[] = [
    ...
    { status: "applied", label: "Applied", color: "#60a5fa" },
    { status: "interview", label: "Interview", color: "#f59e0b" },
    { status: "offer", label: "Offer", color: "#4f46e5" },
  ];
...
const workspaceCSS = `
  * { box-sizing: border-box; }
  .ws {
    ...
    --ws-panel-2:#13243a;
    --ws-panel-3:#162b46;
    --ws-border:rgba(148,163,184,0.14);
    --ws-border-strong:rgba(96,165,250,0.3);
    --ws-text:#e8eefc;
    --ws-muted:#9eb0cb;
    --ws-soft:#7084a3;
    --ws-accent:#2563eb;
    --ws-accent-strong:#93c5fd;
    --ws-warm:#f59e0b;
    --ws-success:#3b82f6;
  ...
  .ws-stage-btn:hover { background:rgba(19,36,58,0.92); border-color:var(--ws-border-strong); transform:translateX(2px); }
  .ws-stage-btn:disabled { cursor:not-allowed; opacity:0.72; }
  .ws-stage-btn:disabled:hover { transform:none; }
  .ws-stage-active {
    background:linear-gradient(180deg, rgba(19,36,58,0.98), rgba(15,27,45,0.96));
    border-color:rgba(37,99,235,0.32);
    box-shadow:inset 0 1px 0 rgba(255,255,255,0.05), 0 16px 30px rgba(4,10,14,0.26);
  }
  .ws-stage-locked { opacity:0.6; }
  .ws-stage-ready .ws-stage-index { border-color:rgba(37,99,235,0.28); color:var(--ws-accent-strong); }
  ...
  .ws-stage-complete {
    background:rgba(37,99,235,0.14); border-color:rgba(37,99,235,0.28); color:#bfdbfe;
  }
  ...
  .ws-rail-card {
    ...
    background:
      ...
      linear-gradient(180deg, rgba(15,27,45,0.98), rgba(10,22,40,0.98));
  ...
  .ws-rail-cta:hover, .wf-primary:hover, .wf-primary-link:hover {
    background:#1d4ed8;
    transform:translateY(-1px);
    box-shadow:0 20px 34px rgba(14,42,99,0.36);
  }
  ...
  .ws-side-icon-active { background:#0f1c36; color:var(--ws-accent-strong); border-color:rgba(37,99,235,0.3); }
  ...
  .ws-mobile-objective {
    ...
    background:
      ...
      linear-gradient(135deg, rgba(15,27,45,0.98), rgba(19,36,58,0.9));
  ...
  .ws-header {
    ...
    background:
      ...
      linear-gradient(180deg, rgba(7,17,31,0.94), rgba(10,24,42,0.76));
  }
  ...
  .ws-focus-pill {
    ...
    background:rgba(15,27,45,0.84); border:1px solid var(--ws-border);
  }
  ...
  .ws-cmd-btn { padding:6px 11px; border-radius:8px; background:rgba(15,27,45,0.9); border:1px solid var(--ws-border); color:var(--ws-soft); font-size:0.6875rem; font-family:"IBM Plex Mono","SFMono-Regular",monospace; font-weight:600; cursor:pointer; transition:all 0.15s; }
  .ws-cmd-btn:hover { border-color:var(--ws-accent); color:var(--ws-accent-strong); }
  .ws-user-pill { display:flex; align-items:center; gap:8px; padding:4px 12px 4px 4px; border-radius:10px; background:rgba(15,27,45,0.9); border:1px solid var(--ws-border); }
  ...
  .ws-copilot {
    width:340px; flex-shrink:0; border-left:1px solid var(--ws-border);
    background:
      linear-gradient(180deg, rgba(255,255,255,0.015), transparent 18%),
      rgba(7,17,31,0.92);
  }
  ...
  .ws-dot-green { background:#60a5fa; box-shadow:0 0 6px rgba(96,165,250,0.42); }
  ...
  .wf-stage-complete { color:#bfdbfe; border-color:rgba(37,99,235,0.3); background:rgba(37,99,235,0.08); }
  .wf-stage-in_progress { color:#deb17a; border-color:rgba(198,145,83,0.3); background:rgba(198,145,83,0.08); }
  .wf-stage-ready { color:var(--ws-accent-strong); border-color:rgba(37,99,235,0.3); background:rgba(37,99,235,0.08); }
  .wf-stage-locked { color:var(--ws-muted); border-color:var(--ws-border); background:#0d1829; }
  .wf-dot {
    width:10px; height:10px; border-radius:999px; background:#334155;
    box-shadow:0 0 0 4px rgba(51,65,85,0.18);
  }
  .wf-dot-complete { background:var(--ws-success); box-shadow:0 0 0 4px rgba(37,99,235,0.16); }
  ...
  .wf-match-score {
    padding:6px 10px; border-radius:999px; background:rgba(37,99,235,0.12);
    border:1px solid rgba(37,99,235,0.22); color:var(--ws-accent-strong); font-size:0.78rem; font-weight:700;
  }
  .wf-secondary {
    display:inline-flex; align-items:center; justify-content:center;
    padding:10px 14px; border-radius:999px; border:1px solid var(--ws-border);
    background:rgba(15,27,45,0.9); color:#d3dde1; font-size:0.8rem; font-weight:600; cursor:pointer;
  ...
  .toast-success { border-color:rgba(37,99,235,0.34); }
  .toast-success .toast-icon { color:#93c5fd; }
  ...
  .prep-score-hi .prep-score-circle { background:rgba(37,99,235,0.12); border:2px solid var(--ws-success); }
  ...
  .prep-score-hi .prep-score-num { color:#93c5fd; }
  ...
  .prep-tab-active { color:var(--ws-accent-strong) !important; border-color:rgba(37,99,235,0.3) !important; background:rgba(37,99,235,0.08) !important; }
  ...
  .prep-tip-bullet {
    ...
    flex-shrink:0; margin-top:6px; box-shadow:0 0 0 4px rgba(37,99,235,0.12);
  }
  ...
  .prep-skill-matched { background:rgba(37,99,235,0.1); border:1px solid rgba(37,99,235,0.34); color:#bfdbfe; }
  ...
  .prep-btn-primary:hover { background:#1d4ed8; }
  ...
  .prep-btn-apply {
    ...
    background:var(--ws-accent); color:#fff; font-size:0.8125rem; font-weight:700; text-decoration:none; transition:all 0.15s;
  }
  .prep-btn-apply:hover { background:#1d4ed8; }
  ...
  .prep-tailor-loading::before { content:""; width:18px; height:18px; border:2px solid rgba(37,99,235,0.26); border-top-color:var(--ws-accent); border-radius:50%; animation:spin 0.8s linear infinite; }
  ...
  .prep-ats-good { background:rgba(37,99,235,0.08); border:1px solid rgba(37,99,235,0.28); }
  ...
  .prep-ats-good strong { color:#93c5fd; }
  ...
  .prep-ats-tag-match { padding:4px 12px; border-radius:999px; font-size:0.75rem; background:rgba(37,99,235,0.1); border:1px solid rgba(37,99,235,0.34); color:#bfdbfe; }
  ...
  .jb-field input:focus { outline:none; border-color:var(--ws-accent); box-shadow:0 0 0 3px rgba(37,99,235,0.12); }
  ...
  .jb-search-btn:hover { background:#1d4ed8; transform:translateY(-1px); }
  ...
  .jb-target-banner {
    ...
    background:
      ...
      linear-gradient(135deg, rgba(15,27,45,0.96), rgba(19,36,58,0.9));
    border:1px solid rgba(37,99,235,0.14);
  }
  ...
  .jb-card-hi { border-left:3px solid var(--ws-accent); }
  ...
  .jb-score-hi { background:rgba(37,99,235,0.15); color:#bfdbfe; border:1px solid rgba(37,99,235,0.28); }
  ...
  .jb-salary { color:#93c5fd !important; font-weight:600; }
  ...
  .jb-prepare-btn { display:inline-flex; align-items:center; gap:6px; padding:9px 20px; border-radius:999px; background:var(--ws-accent); border:none; color:#fff; font-size:0.8125rem; font-weight:700; cursor:pointer; transition:all 0.15s; box-shadow:0 10px 20px rgba(14,42,99,0.26); }
  .jb-prepare-btn:hover { background:#1d4ed8; transform:translateY(-1px); box-shadow:0 14px 24px rgba(14,42,99,0.34); }
  .jb-apply-btn { display:inline-flex; align-items:center; gap:4px; padding:7px 16px; border-radius:999px; background:transparent; border:1px solid rgba(37,99,235,0.34); color:#bfdbfe; font-size:0.75rem; font-weight:700; text-decoration:none; transition:all 0.15s; }
  .jb-apply-btn:hover { background:rgba(37,99,235,0.08); }
  ...
  .jb-target-active { border-color:var(--ws-accent); color:var(--ws-accent-strong); background:rgba(37,99,235,0.08); }
  ...
  .tk-card-salary { font-size:0.625rem; color:#93c5fd; display:block; margin-top:1px; }
  ...
  .cl-field input:focus { border-color:var(--ws-accent); box-shadow:0 0 0 3px rgba(37,99,235,0.12); }
  ...
  .cl-generate-btn:hover { background:#1d4ed8; }
  ...
  .cl-editor textarea:focus { border-color:var(--ws-accent); box-shadow:0 0 0 3px rgba(37,99,235,0.12); }
  ...
  .sp-field input:focus { border-color:var(--ws-accent); box-shadow:0 0 0 3px rgba(37,99,235,0.12); }
  ...
  @media (max-width: 900px) {
    ...
    .ws-mobile-shell {
      ...
      z-index:12;
      padding:12px 12px 0;
      background:linear-gradient(180deg, rgba(7,17,31,0.98), rgba(10,24,42,0.92), rgba(10,24,42,0.74), transparent);
      backdrop-filter:blur(18px);
    }
