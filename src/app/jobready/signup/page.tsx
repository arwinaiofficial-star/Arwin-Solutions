...
const highlights = [
  "Import a resume or describe your background in plain language.",
  "Move from resume strength to matched roles without losing context.",
  "Tailored resume versions, cover letters, and tracking stay connected.",
];
        ...
        <div className="auth-layout">
          <section className="auth-story">
            ...
            <div className="auth-story-copy">
              ...
              <h1>Start a cleaner application workflow.</h1>
              <p>
                Build your resume, review fit, tailor for the right role, and track every application in one connected system.
              </p>
            </div>
            ...
            <div className="auth-story-panel">
              <div className="auth-story-kicker">
                <BotIcon size={15} />
                <span>What opens after signup</span>
              </div>
          ...
          <section className="auth-card">
            <div className="auth-card-header">
              <span className="auth-card-eyebrow">New Workspace</span>
              <h2>Create your account</h2>
              <p>Set up access to your resume, matched roles, and application pipeline.</p>
            </div>
            ...
            <div className="auth-inline-note">
              Social sign-in will return only after the production OAuth flow is fully connected.
            </div>
