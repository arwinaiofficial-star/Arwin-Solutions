  ...
  howItWorks: [
    {
      ...
      description: "Complete a simple form with your skills, experience, and job preferences.",
    },
    {
      step: 2,
    ...
    {
      step: 4,
      title: "Future: Auto-Apply",
      description: "Phase 2 will automatically submit applications on your behalf. Just fill the form once.",
    },
  ],
};
